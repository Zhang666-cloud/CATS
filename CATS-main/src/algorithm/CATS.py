...
class CATSTestServer(BaseServer):
    ...
    def __init__(self, train_datasets, test_datasets, args):
        ...
        self.train_clients = {cid: ATP_PLPDTestClient(cid, datasets, args) for cid, datasets in train_datasets.items()}
        self.test_clients = {cid: ATP_PLPDTestClient(cid, datasets, args) for cid, datasets in test_datasets.items()}
...
class ATP_PLPDTestClient(BaseClient):
    ...
    def adapt_one_step(self, model, adapt_lrs, *X, Y, unspv_loss_func, args,all_plpd):
        ...
        # deyo_margin = 0.4 * math.log(200)
        #
        # filter_ids_1 = torch.where((loss < deyo_margin))
    ...
    def local_eval(self, model, adapt_lrs, args, dataset='test'):
        ...
        class_plpd_values = load_class_plpd('/mnt/sda/PythonProject/ZYF_projects/ATP-master/save_plpd/avg_len_4_plpd_values_cifar100.pkl')
