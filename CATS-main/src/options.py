...
from src.dataset import shapes_in, shapes_out
...
def args_parser():
    ...
    parser.add_argument('--dataset', type=str, default='cifar100',
                        # choices=['cifar10', 'cifar100', 'digit', 'pacs_aug','office_home_aug','tiny_imagenet'],
                        help='dataset name')

    parser.add_argument('--num_clients', type=int, default=300,
                        help='number of clients')

    parser.add_argument('--partition', type=str, default='stratified',
    ...
    parser.add_argument('--algorithm', type=str, default='ece',
    ...
    parser.add_argument('--grad_norm', type=str, default='none',
                        # choices=['none', 'sqrt_numel', 'numel'],
                        help='how to normalize gradient')

    parser.add_argument('--test', type=str, default='batch',
                        help='batch | online_exp')

    parser.add_argument('--load_adapt_path', type=str, default='/mnt/sda/PythonProject/ZYF_projects/ATP-master/history/cifar100/feat/digits_train_300_0.2_0.2_c_atp_resnet18_pseed_0_seed_0.pkl',
    ...
    parser.add_argument('--tta_epochs', type=int, default=5,
                        help='epochs of tta')
    # ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ========
    # Other Config
    # ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ======== ========
    ...
    parser.add_argument('--load_model_path', type=str, default='/mnt/sda/PythonProject/ZYF_projects/ATP-master/weights/cifar100/feat/digits_train_300_0.2_0.2_c_pretrain_fedavg_resnet18_pseed_0_seed_0.pkl')
